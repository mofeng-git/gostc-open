...
import (
	...
	"crypto/tls"
	"fmt"
	"gostc-sub/pkg/p2p/pkg/auth"
	v1 "gostc-sub/pkg/p2p/pkg/config/v1"
	"gostc-sub/pkg/p2p/pkg/msg"
	"gostc-sub/pkg/p2p/pkg/nathole"
	plugin "gostc-sub/pkg/p2p/pkg/plugin/server"
	"gostc-sub/pkg/p2p/pkg/transport"
	"gostc-sub/pkg/p2p/pkg/util/log"
	"gostc-sub/pkg/p2p/pkg/util/util"
	"gostc-sub/pkg/p2p/pkg/util/version"
	"gostc-sub/pkg/p2p/pkg/util/xlog"
	"gostc-sub/pkg/p2p/server/controller"
	"gostc-sub/pkg/p2p/server/metrics"
	"gostc-sub/pkg/p2p/server/proxy"
	"gostc-sub/pkg/p2p/server/visitor"
	"io"
	"net"
	"os"
	"strconv"
	...
	netpkg "gostc-sub/pkg/p2p/pkg/util/net"
)
