...
import {apiAdminGostClientForwardConfig} from "../../../api/admin/gost_client_forward.js";
...
const pageFunc = async () => {
  try {
    ...
    let res = await apiAdminGostClientTunnelPage(state.value.table.search)
...
const deleteFunc = async (row) => {
  try {
    await apiAdminGostClientTunnelDelete({code: row.code})
    searchTable()
  } finally {
  }
}
