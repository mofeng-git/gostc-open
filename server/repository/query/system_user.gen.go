...
func newSystemUser(db *gorm.DB, opts ...gen.DOOption) systemUser {
	...
	_systemUser.Id = field.NewInt(tableName, "id")
	...
	_systemUser.Salt = field.NewString(tableName, "salt")
...
func (s *systemUser) updateTableName(table string) *systemUser {
	...
	s.OtpKey = field.NewString(table, "otp_key")
	s.Admin = field.NewInt(table, "admin")
