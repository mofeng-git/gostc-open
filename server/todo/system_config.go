...
func systemConfig() {
	...
	_ = db.SystemConfig.Create(model.GenerateSystemConfigBase("GOSTC", "https://oss.sian.one/static/master/325ebdbe993146e08f9a7aa5b8e59d02.png", "https://gost.sian.one", "", "2", "2")...)
